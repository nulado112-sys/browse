...
export const menuData: MenuCategory[] = [
  ...
  },
  {
    ...
    icon: "🥗",
    items: [
      { name: "Chicken Caesar", desc: "Lettuce, Parmesan, Croutons, Chicken, Caesar Sauce", price: "8" },
      { name: "Crab Salad", desc: "Iceberg, Corn, Crab, Mustard Sauce", price: "7.5" },
      { name: "Green Salad", price: "4.5" },
      { name: "Feta Salad", price: "8" },
      { name: "Nacho Salad", price: "8.5" },
      { name: "Crispy Chicken Caesar", price: "8" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Chicken Light", desc: "Chicken, Rocca, Pickles, Tomato, Light Mayo", price: "7.5" },
      ...
      { name: "Chicken Bomb", desc: "Chicken, Pepper, Onion, Corn, Fresh Mushrooms, Mozzarella, Special Sauce", price: "7.5" },
